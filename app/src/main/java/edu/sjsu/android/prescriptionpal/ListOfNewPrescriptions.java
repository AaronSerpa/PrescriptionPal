...
public class ListOfNewPrescriptions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_of_new_prescriptions);
        ...
        fStore.collection("PharmacyAccountType").document("R4lp3HKqtKCQ3SCiXD26").addSnapshotListener(new EventListener<DocumentSnapshot>(){
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                input = (List<String>) documentSnapshot.get("Fill Requests");
            }
        });
        ...
        mAdapter=new MyAdapter(input, "Fill");
