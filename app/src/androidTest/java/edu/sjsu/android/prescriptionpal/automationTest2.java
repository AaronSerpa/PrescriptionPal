...
public class automationTest2 {
    public static void main(String args[]) throws MalformedURLException, InterruptedException {
        ...
        // Test 2: Test if user can add his/her valid information to the database successfully
        TimeUnit.SECONDS.sleep(3);
        ...
        // Test post condition
        TimeUnit.SECONDS.sleep(3);
        MobileElement result2 = (MobileElement) driver.findElementById("edu.sjsu.android.prescriptionpal:id/button_pharmacy");
        Assert.assertEquals(result2.getText(), "PHARMACY");
        TimeUnit.SECONDS.sleep(3);
        driver.quit();
